				...
				<div class="store-wrapper">
					...
					if($loop->have_posts()) { 
						...
						while($loop->have_posts()) {
							$loop-> the_post();
							if($i==1 || $i==4){
								$redirect_url = get_field('redirect_url') != "" || get_field('redirect_url') != null ? get_field('redirect_url') : get_permalink();
								?>
							...
							<div class="blog-in-wrap <?php if($j%2==0){echo "even";} else{echo "odd";}?>">
								...
								<div class="blog-content-wrap">
									...
									<div class="blog-content">
										<?php echo eightstore_lite_excerpt(get_the_content(), 120); ?>
